...
public class SoundscapeItems {
    ...
    public static final Item AMBIENCE_DISC = registerItem("ambience_disc",
            new Item(createSettings("ambience_disc").stacksTo(1)));
    ...
    private static Item.Properties createSettings(String name) {
        return new Item.Properties()
                .setId(ResourceKey.create(Registries.ITEM, SoundscapeId.of(name)));
    }

    private static Item.Properties createDiscSettings(String name, String songName) {
        return new Item.Properties()
                .stacksTo(1)
                .setId(ResourceKey.create(Registries.ITEM, SoundscapeId.of(name)))
                .jukeboxPlayable(ResourceKey.create(Registries.JUKEBOX_SONG, SoundscapeId.of(songName)));
    }

    private static Item registerItem(String name, Item item) {
        return Registry.register(BuiltInRegistries.ITEM, SoundscapeId.of(name), item);
    }
