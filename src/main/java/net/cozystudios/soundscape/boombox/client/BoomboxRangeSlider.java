...
public class BoomboxRangeSlider extends AbstractSliderButton {
    ...
    public BoomboxRangeSlider(int x, int y, int width, int height, int range, Consumer<Integer> onValueChanged) {
        super(x, y, width, height,
                Component.literal("Range: " + range + " blocks"),
    ...
    protected void updateMessage() {
        setMessage(Component.literal("Range: " + getRangeValue() + " blocks"));
    }
