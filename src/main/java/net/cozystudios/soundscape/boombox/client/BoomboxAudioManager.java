...
public class BoomboxAudioManager {
    ...
    public void playFromPosition(BlockPos pos, String url, float volume, boolean loop, long positionMs, int trackIndex) {
        ...
        lavaPlayerManager.loadItem(url, new AudioLoadResultHandler() {
            ...
            public void noMatches() {
                ...
                MinecraftClient.getInstance().execute(() -> updateScreenError(pos, "No matches found for URL"));
            }
            ...
            public void loadFailed(FriendlyException exception) {
                ...
                MinecraftClient.getInstance().execute(() -> updateScreenError(pos, "Load failed: " + exception.getMessage()));
            }
        });
    }
    ...
    public void tick(PlayerEntity player) {
        ...
        *///?} else {
        ...
        activeBoomboxes.entrySet().removeIf(entry -> {
            ...
            double distance = Math.sqrt(player.squaredDistanceTo(Vec3d.ofCenter(boomboxPos)));
    ...
    private void updateScreenError(BlockPos pos, String error) {
        ...
        if (client.currentScreen instanceof BoomboxScreen screen
